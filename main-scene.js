...
//=================================================VARIABLE DECLARATIONS=================================================
        ...
        //Camera location for showing welcome page
        this.camera_position_welcome = Mat4.look_at(vec3(0,0,50),vec3(0,0,0),vec3(0,1,0));
...
//=================================================Welcome Page=============================================================
        ...
        if(this.show_welcome_page) {
            ...
            // string = "Score: 10\nLevel: 1";
            // this.shapes.text.set_string(string, context.context);
            // let text_transform_score_board = Mat4.identity();
            // text_transform_score_board = Mat4.inverse(program_state.camera_inverse);
            // this.shapes.text.draw(context, program_state, text_transform_score_board, this.materials.text_material);
...
//=================================================FISHING ROD & HOOK=================================================
 ...
 //=================================================HOOK COLLISION DETECTION=================================================
        ...
        // //Draw Text
        // let string = "I want to show this!!!";
        // this.shapes.text.set_string(string, context.context);
        // let text_transfrom = Mat4.identity();
        // text_transfrom = text_transfrom.times(Mat4.translation(0,10,0));
        // text_transfrom = text_transfrom.times(Mat4.scale(5,5,5));
        // this.shapes.text.draw(context, program_state, text_transfrom, this.materials.text_material);
